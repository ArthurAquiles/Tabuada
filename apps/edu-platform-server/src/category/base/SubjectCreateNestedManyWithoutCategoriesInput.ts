...
@InputType()
class SubjectCreateNestedManyWithoutCategoriesInput {
...
export { SubjectCreateNestedManyWithoutCategoriesInput as SubjectCreateNestedManyWithoutCategoriesInput };
